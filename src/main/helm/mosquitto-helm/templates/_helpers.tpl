...
*/}}
{{- define "mosquitto-helm.fullname" -}}
...
Common labels
*/}}
{{- define "mosquitto-helm.labels" -}}
app.kubernetes.io/name: {{ include "mosquitto-helm.name" . }}
helm.sh/chart: {{ include "mosquitto-helm.chart" . }}
